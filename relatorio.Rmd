...
knitr::kable(medias_tempo, format = "latex", booktabs = TRUE, caption = "Tempo (em dias) até a  análise \\label{tab:tab2}") |> 
...
knitr::kable(medias_tempo_df2, format = "latex", booktabs = TRUE, caption = "Tempo (em dias) até a  análise - Ácidos Halocéticos total\\label{tab:tab2}") |> 
  kable_styling(latex_options = c("striped","HOLD_position"), font_size = 8, full_width = FALSE)
...
ggplot(top_subs_sul, aes(x = reorder(substancia, -n), y = n, fill = uf)) +
  ...
  labs(title = "Top Substâncias por Frequência em Cada Estado",
       x = "Substância",
       y = "Frequência") +
  theme_bw()+

...
# gf2<-ggplot(df_media, aes(x = uf, y = dif_analise_coleta, fill = uf)) +
...
knitr::kable(medias_tempo_df2, format = "latex", booktabs = TRUE, caption = "Tempo (em dias) até a  análise - Ácidos Halocéticos total\\label{tab:tab4}") |> 
  kable_styling(latex_options = c("striped","HOLD_position"), font_size = 8, full_width = FALSE)
...
knitr::kable(medias_tempo_df3, format = "latex", booktabs = TRUE, caption = "Tempo (em dias) até a  análise - Rádio-228\\label{tab:tab5}") |> 
  kable_styling(latex_options = c("striped","HOLD_position"), font_size = 8, full_width = FALSE)
```
...
knitr::kable(medias_tempo_df4, format = "latex", booktabs = TRUE, caption = "Tempo (em dias) até a  análise - Rádio-228\\label{tab:tab6}") |> 
  kable_styling(latex_options = c("striped","HOLD_position"), font_size = 8, full_width = FALSE)
...
knitr::kable(medias_tempo_df6, format = "latex", booktabs = TRUE, caption = "Tempo (em dias) até a  análise - Chumbo\\label{tab:tab7}") |> 
  kable_styling(latex_options = c("striped","HOLD_position"), font_size = 8, full_width = FALSE)
...
knitr::kable(medias_tempo_df7, format = "latex", booktabs = TRUE, caption = "Tempo (em dias) até a  análise - Mercúrio\\label{tab:tab8}") |> 
  kable_styling(latex_options = c("striped","HOLD_position"), font_size = 8, full_width = FALSE)
